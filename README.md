...
1. You're going to make a game where the computer randomly picks a letter, and the user has to guess which letter the computer chose. Put the following text on your page:
